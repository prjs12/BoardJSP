...
public class ModifyArticleHandler implements CommandHandler{
	...
	private String processForm(HttpServletRequest req, HttpServletResponse res) throws SQLException, IOException {
	...
	private boolean canModify(User authUser, ArticleData articleData) {
		String writedId = articleData.getArticle().getWriter().getId();
		return authUser.getId().equals(writedId);
	}
